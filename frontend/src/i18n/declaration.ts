...
export enum I18nKey {
  ...
  SETTINGS$ARTIFACTORY_TITLE = "SETTINGS$ARTIFACTORY_TITLE",
  SETTINGS$ARTIFACTORY_DESCRIPTION = "SETTINGS$ARTIFACTORY_DESCRIPTION",
  SETTINGS$ARTIFACTORY_HOST = "SETTINGS$ARTIFACTORY_HOST",
  SETTINGS$ARTIFACTORY_CLI_INSTALL_URL = "SETTINGS$ARTIFACTORY_CLI_INSTALL_URL",
  SETTINGS$ARTIFACTORY_CLI_INSTALL_URL_PLACEHOLDER = "SETTINGS$ARTIFACTORY_CLI_INSTALL_URL_PLACEHOLDER",
  SETTINGS$ARTIFACTORY_API_KEY = "SETTINGS$ARTIFACTORY_API_KEY",
  SETTINGS$ARTIFACTORY_API_KEY_PLACEHOLDER = "SETTINGS$ARTIFACTORY_API_KEY_PLACEHOLDER",
  SETTINGS$ARTIFACTORY_CLEAR_KEY = "SETTINGS$ARTIFACTORY_CLEAR_KEY",
  SETTINGS$ARTIFACTORY_REPOSITORIES = "SETTINGS$ARTIFACTORY_REPOSITORIES",
  SETTINGS$ARTIFACTORY_REPOSITORIES_DESCRIPTION = "SETTINGS$ARTIFACTORY_REPOSITORIES_DESCRIPTION",
  SETTINGS$ARTIFACTORY_REPOSITORIES_EMPTY = "SETTINGS$ARTIFACTORY_REPOSITORIES_EMPTY",
  SETTINGS$ARTIFACTORY_REPOSITORY_TYPE_LABEL = "SETTINGS$ARTIFACTORY_REPOSITORY_TYPE_LABEL",
  SETTINGS$ARTIFACTORY_REPOSITORY_TYPE_PLACEHOLDER = "SETTINGS$ARTIFACTORY_REPOSITORY_TYPE_PLACEHOLDER",
  SETTINGS$ARTIFACTORY_REPOSITORY_NAME_LABEL = "SETTINGS$ARTIFACTORY_REPOSITORY_NAME_LABEL",
  SETTINGS$ARTIFACTORY_REPOSITORY_PLACEHOLDER = "SETTINGS$ARTIFACTORY_REPOSITORY_PLACEHOLDER",
  SETTINGS$ARTIFACTORY_REPOSITORY_LOADING = "SETTINGS$ARTIFACTORY_REPOSITORY_LOADING",
  SETTINGS$ARTIFACTORY_REPOSITORY_EMPTY_RESULTS = "SETTINGS$ARTIFACTORY_REPOSITORY_EMPTY_RESULTS",
  SETTINGS$ARTIFACTORY_ADD_REPOSITORY = "SETTINGS$ARTIFACTORY_ADD_REPOSITORY",
  SETTINGS$ARTIFACTORY_REMOVE_REPOSITORY = "SETTINGS$ARTIFACTORY_REMOVE_REPOSITORY",
  SETTINGS$ARTIFACTORY_REPO_PYPI = "SETTINGS$ARTIFACTORY_REPO_PYPI",
  SETTINGS$ARTIFACTORY_REPO_NPM = "SETTINGS$ARTIFACTORY_REPO_NPM",
  SETTINGS$ARTIFACTORY_REPO_MAVEN = "SETTINGS$ARTIFACTORY_REPO_MAVEN",
  SETTINGS$ARTIFACTORY_REPO_GRADLE = "SETTINGS$ARTIFACTORY_REPO_GRADLE",
  SETTINGS$ARTIFACTORY_REPO_GO = "SETTINGS$ARTIFACTORY_REPO_GO",
  SETTINGS$ARTIFACTORY_REPO_NUGET = "SETTINGS$ARTIFACTORY_REPO_NUGET",
  SETTINGS$ARTIFACTORY_REPO_DOCKER = "SETTINGS$ARTIFACTORY_REPO_DOCKER",
  SETTINGS$ARTIFACTORY_REPO_HELM = "SETTINGS$ARTIFACTORY_REPO_HELM",
  SETTINGS$ARTIFACTORY_REPO_TERRAFORM = "SETTINGS$ARTIFACTORY_REPO_TERRAFORM",
  SETTINGS$ARTIFACTORY_REPO_CONAN = "SETTINGS$ARTIFACTORY_REPO_CONAN",
  SETTINGS$ARTIFACTORY_REPO_CARGO = "SETTINGS$ARTIFACTORY_REPO_CARGO",
  SETTINGS$ARTIFACTORY_REPO_COMPOSER = "SETTINGS$ARTIFACTORY_REPO_COMPOSER",
  SETTINGS$ARTIFACTORY_REPO_GEMS = "SETTINGS$ARTIFACTORY_REPO_GEMS",
  SETTINGS$ARTIFACTORY_REPO_COCOAPODS = "SETTINGS$ARTIFACTORY_REPO_COCOAPODS",
  SETTINGS$ARTIFACTORY_REPO_CRAN = "SETTINGS$ARTIFACTORY_REPO_CRAN",
  SETTINGS$ARTIFACTORY_REPO_PUB = "SETTINGS$ARTIFACTORY_REPO_PUB",
  SETTINGS$ARTIFACTORY_REPO_SBT = "SETTINGS$ARTIFACTORY_REPO_SBT",
  SETTINGS$ARTIFACTORY_REPO_IVY = "SETTINGS$ARTIFACTORY_REPO_IVY",
  SETTINGS$ARTIFACTORY_REPO_SWIFT = "SETTINGS$ARTIFACTORY_REPO_SWIFT",
  SETTINGS$ARTIFACTORY_REPO_BOWER = "SETTINGS$ARTIFACTORY_REPO_BOWER",
